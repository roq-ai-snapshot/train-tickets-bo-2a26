...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Train Tickets Booking Application`}</title>

        <meta
          name="description"
          content="Experience seamless journeys with Train Tickets Booking Application - TKT, your top-rated online platform for TRN train tickets booking."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/uploads/1413387158190559d80f7/6108b580?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx0cmFpbnxlbnwwfHx8fDE2OTgzMDQ2NDZ8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`Train Tickets Booking Application`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless journeys with Train Tickets Booking Application - TKT, your top-rated online platform for TRN train tickets booking.`}
            </Text>
            <Box
